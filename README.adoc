...
* student1 == Dalton Bilau Goncalves
* student2 == Nusrat Afrin
* student3 == Oliver MacDonald
...
Create the index page for a University major. You must use templates for this
